...
0x6d,0x7d,0x07,0x7f,0x6f,0x77,0x7c,0x58,0x5e,0x7b,0x72,0};
...
void VTareaInterfaz( void *pvParameters){
    //int indice=2;

    char codigo;

    for(;;){
        //espera indefinidamente a recibir una tecla de la tarea de teclado
        xQueueReceive(xColaTeclado,&codigo,portMAX_DELAY);
        digitos[0]= 16;
        digitos[1]= 16;
        digitos[2]= (int) codigo;

        dsegundos=(int) codigo;
